	...
	public SettingsComponentDescription getSettingsComponentDescription(QuestionTreeNode node) {
		...
		if (node.isExperiment()) {
			result.addSubComponent(new SettingsComponentDescription(SettingsTextField.class, KEY_MAX_TIME,
					"Maximam Time (of the Experiment, in minutes):"));
		}
		if (node.isCategory()) {
			result.addSubComponent(new SettingsComponentDescription(SettingsTextField.class, KEY_MAX_TIME,
					"Maximam Time (of the catagory, in seconds):"));
		}
		if (node.isQuestion()) {
			result.addSubComponent(new SettingsComponentDescription(SettingsTextField.class, KEY_MAX_TIME,
					"Maximam Time (of the question, in seconds):"));
		}
		SettingsPluginComponentDescription hardExit = new SettingsPluginComponentDescription(KEY_HARD_EXIT,
				"Question displayed at the end of overtime (hard Timeout)", true);
